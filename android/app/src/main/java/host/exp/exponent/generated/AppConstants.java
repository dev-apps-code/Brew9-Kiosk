...
public class AppConstants {
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
      ...
      embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@jasonfoo/brew9-menu-app", "assets://shell-app-manifest.json", "application/json"));
      embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40jasonfoo%2Fbrew9-menu-app%2F1.0.0%2F0d526cbd4669b481c640d9fa454f53f2-35.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
